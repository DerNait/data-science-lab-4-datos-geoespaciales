// Copia textual, sin modificar, del script de detección de cianobacteria elegido.
//
...
// Fuente:   https://github.com/sentinel-hub/custom-scripts/blob/master/sentinel-2/cyanobacteria_chla_ndci_l1c/script.js
// Fecha de consulta: 2026-08-13
// Producto Sentinel-2 compatible: L1C (reflectancia TOA)
//
// Este archivo se conserva sin alterar como evidencia auditable del script
// original. NO se usa directamente para pedir datos: su salida es una
// visualización RGB (mapa de color), no un raster numérico. La versión
// numérica adaptada para este laboratorio está en
// `cyano_ndci_l1c_numeric.js` y preserva exactamente la misma fórmula y los
// mismos umbrales que aparecen aquí abajo.
